...
class ProductServiceTest {
    ...
    void shouldRetrieveAllProducts(){
        List<Product> expectedProducts = List.of(new Product(1L, "first-product", null, 0), new Product(2L, "second-product", null, 0));
    ...
    void shouldCreateANewProductWithQuantityZero(){
        Product productToSave = new Product("new-product", null, 0);
